  ...
  return (
    <footer className="bg-black text-gray-100 relative">
      <div className="max-w-7xl mx-auto">
        {/* Top Section */}
        <section className="flex flex-wrap justify-between border-b-2 border-[rgb(255,159,13)] px-6 lg:px-24 py-12">
          <div className="mb-6 lg:mb-0">
            <h2 className="text-3xl font-bold">
              <span className="text-[rgb(255,159,13)]">St</span>ill need our support?
            </h2>
            <p className="mt-2">
          ...
          <div className="flex flex-wrap items-center">
            <input
              ...
              className="bg-[rgb(255,159,13)] text-gray-100 px-4 py-2 rounded-l-md outline-none"
            />
            <button className="bg-white text-[rgb(255,159,13)] px-4 py-2 rounded-r-md">
              Subscribe now
            </button>
          </div>
        </section>
        ...
        <section className="flex flex-wrap justify-between mt-10 px-6 lg:px-24">
          ...
          <div className="mb-8 lg:mb-0 lg:w-1/4">
            ...
            <p>
              FoodTruck is your go-to spot for discovering delicious eats on wheels.  We connect you with local food trucks, making it easy to find your next favorite meal.
            </p>

            <div className="mt-4">
              <p className="flex items-center">
                <span className="bg-[rgb(255,159,13)] text-white text-xl mr-2 p-2">
                  <FaRegClock />
                </span>
                Mon - Sat (8.00 - 6.00)
              </p>
          ...
          <div className="mb-8 lg:mb-0 lg:w-1/4">
            ...
            <ul>
              <Link href='/About'>
                <li className="my-2 hover:text-[rgb(255,159,13)] cursor-pointer">
                  About
                </li></Link>
              <li className="my-2 hover:text-[rgb(255,159,13)] cursor-pointer">
                News
          ...
          <div className="mb-8 lg:mb-0 lg:w-1/4">
            ...
            <ul>
              <Link href='Faq'>
                <li className="my-2 hover:text-[rgb(255,159,13)] cursor-pointer">FAQ</li></Link>
          ...
          <div className="lg:w-1/4">
            ...
            <div className="flex items-center my-2 hover:bg-gray-100/10 p-2 rounded">
              ...
              <div>
                <p className="text-sm text-gray-400">Change your food habit
                  With organic food</p>
                <p>01 Feb 2025</p>
              </div>
            </div>
      ...
      <section className="bg-[rgb(79,79,79)] h-16 mt-2">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 lg:px-24 h-full">
          <p>Copyright © 2025 by uzair. All Rights Reserved.</p>
          <div className="flex space-x-4">
            {/* Facebook */}
            <a
              href="https://www.linkedin.com/in/webdeveloper-nextjs-mernstack-expert/"
              target="_blank"
