...
const HeroSection = () => {
  ...
  ></div>
      ...
      <div className="relative container mx-auto flex flex-col lg:flex-row items-center justify-between py-16 px-6 md:px-12 lg:px-28">
        ...
        <div className="flex flex-col items-start lg:w-6/12 z-10">
          <span className="text-[#FF9F0D] font-semibold text-lg mb-2">
            Its Quick & Amusing!
          </span>
          ...
          <Link
            href="/menu"
            className="bg-transparent border-2 border-[#FF9F0D] text-[#FF9F0D] hover:bg-[#FF9F0D] hover:text-black font-medium py-3 px-6 rounded-full transition duration-300"
          >
            See Menu
          </Link>
        </div>
  ...
  <div className="flex flex-col space-y-4">
    <div className="w-10 h-10 flex items-center justify-center text-orange rounded-full cursor-pointer hover:bg-[#FF9F0D] hover:text-white transition duration-300">
      <FaFacebookF size={18} />
    </div>
    <div className="w-10 h-10 flex items-center justify-center text-orange rounded-full cursor-pointer hover:bg-[#FF9F0D] hover:text-white transition duration-300">
      <FaTwitter size={18} />
